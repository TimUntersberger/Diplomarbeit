...
\begin{abstract}
	Die Konzentration der Schüler während des Unterrichts ist wichtig. Doch sehr oft kommt es vor, dass in einem Klassenraum Sauerstoffmangel herrscht. Deswegen wurde von der HTBLA-Leonding ein Mesh-Netzwerk aus Mikrocontrollern in Auftrag gegeben. Dieses Mesh-Netzwerk ermöglicht  sämtlichen Sensoren und Aktoren, welche in der Schule untergebracht sind, Nachrichten untereinander zu versenden.

	Die Vorteile eines Mesh-Netzwerkes gegenüber einem normalen Wi-Fi Netzwerk sind, dass:
	\begin{itemize}
		\item jeder Mikrocontroller einen eigenen Access Point öffnet und somit das Mesh-Netzwerk an größere Reichweite gelangt.
		...
		\item der Benutzer sich nicht darum kümmern muss, mit welchem Knoten er sich verbindet. Aus der Sicht des Benutzers sehen die verschiedenen Accesspoints der Mikrocontroller wie ein großes Wi-Fi Netzwerk aus.
	\end{itemize}
	\begin{figure}[H]
        \begin{center}
