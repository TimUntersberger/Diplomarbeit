...
%TODO: Erklären was ESP-IDF bedeutet und allgemeines dazu
...
Da die meisten Espressif Libraries Funktionalitäten aus der Programmiersprache C verwenden, welche nicht in C++ unterstützt werden, und die Libraries von Professor Köck in C++ implementiert wurden, ist es nicht leicht möglich, diese gleichzeitig zu verwenden. 
