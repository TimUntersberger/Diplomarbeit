...
% TODO: wie eine .projbuild datei funktioniert
...
Ist dies nicht der Fall, kann das Programm mit diesem Befehl auf den ESP geflashet werden:
\begin{verbatim}
    idf.py flash
\end{verbatim}
...
Die Funktionalität des Programmes kann mit folgendem Befehl auf dem IDF Monitor, welcher in Kapitel \ref{sec:monitor} näher beschrieben wird, überprüft werden.

\begin{verbatim}
    idf.py monitor
\end{verbatim}

Mit dem nachstehenden Befehl kann das Programm gebuildet, geflashet und upgeloadet werden. Dies erspart den Aufwand jeden Befehl einzeln einzugeben.
