...
\begin{itemize}
    ...
    \begin{figure}[H]
        \begin{center}
            \includegraphics[scale=0.8]{images/dht22_formfaktor.png}
            \caption{Formfaktor Dht22 \cite{dht22_formfactor}}
        \end{center}
    \end{figure}
    \item 
\end{itemize}
Zu den weiteren Vorteilen des Sensors zählt ein kleiner Formfaktor, niedriger Stromverbrauch und eine Übertragunsdistanz von bis zu 20 Metern.
