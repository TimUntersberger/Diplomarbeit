...
Diese Mesh Library basiert auf eine First-In-First-Out-Queue (FIFO Queue), welche periodisch versendet wird. 

Jeglicher Command kann mithilfe der \textit{mesh_queue_cmd} Funktion zu dieser FIFO Queue hinzugefügt werden.

% was ist ein mesh command erklären
% command architektur erlären

\subsubsection{Dht22}\label{sec:own-libraries-dht22}
